...
function Categories() {
  ...
  const trendingCategories = useQuery<GifCategory[]>(() => ({
    ...
    queryFn: () => {
      ...
      return fetch("https://stoat.dewrito.net/gifbox/categories?locale=en_US", {
        headers: {
  ...
  const trendingGif = useQuery<GifResult | null>(() => ({
    ...
    queryFn: () => {
      ...
      return fetch("https://stoat.dewrito.net/gifbox/trending?locale=en_US&limit=1", {
        headers: {
          [authHeader]: authHeaderValue,
        },
      })
...
function GifSearch(props: { query: string }) {
  ...
  const search = useQuery<GifResult[]>(() => ({
    ...
    queryFn: () => {
      ...
      return fetch(
        "https://stoat.dewrito.net/gifbox/" +
